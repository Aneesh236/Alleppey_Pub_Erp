...
function renderDataMode() {
    ...
    const statusText = dashboardData.usingCachedData
        ...
        : `Live database data \u00B7 updated ${dashboardData.lastUpdated.toLocaleTimeString("en-IN", {
            hour: "2-digit",
            minute: "2-digit",
            second: "2-digit"
        })}`;
...
function initializeEvents() {
    ...
    elements.logoutBtn.addEventListener("click", () => {
        ...
        ["authToken", "loggedInUser", "displayName", "userRole", "isLoggedIn", "adminLoggedIn", "authExpiresAt"].forEach(key => {
